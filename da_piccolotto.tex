...
Um für die Interaktion wichtige UI Elemente hervorzuheben, werden diese eingefärbt und der Rest der Komponente abgedunkelt (Abbildung~\ref{figure:ui-howto-step1}). Die Kreise unten links und oben rechts sind abgeschnitten, da die Datenpunkte sich an der Grenze des dargestellten Datenbereichs befinden und von der SVG Maske abgeschnitten werden.
