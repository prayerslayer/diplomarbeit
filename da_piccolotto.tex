...
Die Teilnehmer der Nutzerstudie wurden im Starbucks in Dresden (Prager Straße) zufällig ausgewählt. \todo[inline]{Wobei ich jetzt nicht ausschließen kann, dass ich einen Auswahl-Bias zu jüngeren, netteren, hipperen, sympathischeren, gepflegteren Menschen hatte.} Sie waren zwischen X und Y Jahre alt und zu~50~\% weiblich. Als Gegenleistung für ihre Zeit bekamen sie einen Gutschein über 5~Euro.
...
% leider hab ich auch keinen gefragt, ob er die komm.hilfe verstanden hätte. ich sag einfach ja.

Kein Teilnehmer rief die Kommunikationshilfe auf oder fragte danach, obwohl sie ihnen vermutlich geholfen hätte.

% nach dem jetzt kontrollgruppe und treatment group vom verhalten her quasi identisch ist, macht es auch keinen sinn, hier irgendwelche regressionsanalysen zu machen, mal ganz davon abgesehen, dass die sample size so klein ist.
