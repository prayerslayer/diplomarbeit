...
% wie funktioniert überhaupt sensemaking, also wissensaufnahme? soll ich darauf eingehen? ich bin kein psychologe!

% End-User Hilfe in Desktop Software: Karl Klammer, F1, ?-Button, FAQ, First Steps, Tutorials, Manual
% dazu finde ich nicht so viel. höchstens das paper über posts in foren von adobe und autodesk und DIN 8418: Hinweise zur Erstellung von Benutzerinformatione
...
% intelligente, automatische, what not user assistance, ein bisschen ausblick vielleicht
