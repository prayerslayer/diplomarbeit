...
\begin{itemize}
	...
	\item\textbf{Bedienung}: Das Hilfesystem soll erklären können, wie eine Komponente bedient wird. Diese Informationen umfassen beispielsweise welche Operationen auf welchen DOM Elementen welche Aktionen (eventuell auf welchen Daten) ausführen.
	...
	\item\textbf{Kommunikation}: Das Hilfesystem soll erklären können, wie zwei gegebene Komponenten miteinander kommunizieren.
