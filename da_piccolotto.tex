...
% what to do? ich würde sagen, trotzdem event handler auf relevante ui elemente registrieren. die bekommt das hilfesystem dann ungefähr zeitgleich mit dem event mit und kann sie zuordnen. wobei das auch wieder nicht ganz eindeutig ist, weil ich ja einfach $("button").click() machen kann. aber das ist halt so.
