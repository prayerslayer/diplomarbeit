...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=0.75\textwidth]{images/implementierung-ui-capview.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=\textwidth]{images/implementierung-ui-communication.png}
...
% was in den grundlagen gefunden wurde: dezidierter knowledge view mit asynchron-kollaborative mind map

% frontend: was in der 1. studie gefunden wurde: animierte mauszeiger. sofern man animationen beibehält
...
% backend? weitere operationen und andre teilkonzepte unterstützen
% kategorisierung hell/dunkle komponente
% wenn man jetzt die animationen rauslässt: layoutalgo, eventuell mehr comic-like die bilder - kann man auf alle fälle ausprobieren, ist ja nicht viel aufwand
% was jetzt in der smcdl ist (hasrelativestyle) kann auch im core analysiert werden, vielleicht kann das core auch ein relatives stylesheet generieren und einbinden
