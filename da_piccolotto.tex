...
%TODO Noch auf OWL oder RDF/RDFS eingehen?
...
Beispiele dafür sind Balkendiagramme, Treemaps \cite{Shneiderman1992} und Parallel Coordinates (Abbildung~\ref{figure:parallel_coordinates}) \cite{Inselberg1991}.

%TODO abgrenzung zu infografiken

\begin{figure}[htbp]
   \centering
   \includegraphics[width=0.75\textwidth]{images/grundlagen-parallel_coordinates.png} 
   \caption{Parallel Coordinates}
   \label{figure:parallel_coordinates}
\end{figure}

Keim \cite{Keim2002} klassifiziert Informationsvisualisierungen nach dargestellten Daten, Visualisierungs- und Interaktionstechnik:

%TODO was mache ich hier? ich will einen überblick geben, aber nicht sein ganzes paper abschreiben

\begin{itemize}
	\item Dargestellte Daten
	\begin{itemize}
		\item Eindimensional: Zum Beispiel Zahlenreihen (1992, 1994, 2001, 2002...)
		\item Zweidimensional: Beispielsweise Key/Value Paare (Apple: 445, Google: 873, Microsoft: 34, ...)
		\item Multidimensional: Etwa verschachtelte Key/Value Paare (Apple: \{Stock: 445, Founded: 1976\}, ...) 
		\item Text: Zum Beispiel Blogposts.
		\item Netzwerke/Graphen, wie zum Beispiel die Hyperlinks im World Wide Web.
		\item Software/Algorithmen, beispielsweise welche Prozesse welche Locks halten.
	\end{itemize}
	\item Visualisierungstechniken
	\begin{itemize}
		\item Standard 2D/3D: Balkendiagramme, Liniendiagramme, Karten etc.
		\item Geometrically transformed: Zum Beispiel Parallel Coordinates.
		\item Iconic: Hier werden Bilder zur Informationsvisualisierung benutzt, beispielsweise Smileys \cite{Chernoff1973}.
		\item Dense Pixel: Wie zum Beispiel Recursive Patterns (Abbildung~\ref{figure:recursive_pattern}).
		\item Stacked: Zum Beispiel Treemaps.
	\end{itemize}
	\item Interaktionstechniken
	\begin{itemize}
		\item Standard
		\item Projection
		\item Filtering
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=0.75\textwidth]{images/grundlagen-recursive_pattern.png}
   \caption{Recursive Pattern Visualisierungstechnik}
...
% computer-supported und interactive!
% zoom, pan, fisheye, browse, filter, blahr, link & brush
